...
!----------------------------------------------------------------
! get background
  call get_variable3d( truth_file, 'U_2       ', ix+1, jx, kx, 1, u )
  call get_variable3d( truth_file, 'V_2       ', ix, jx+1, kx, 1, v )
  call get_variable3d( truth_file, 'T_2       ', ix, jx, kx, 1, theta )
  call get_variable3d( truth_file, 'PH_2      ', ix, jx, kx+1, 1, ph )
