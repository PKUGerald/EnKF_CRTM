...
!-- enkf_parameter
   ...
   if ( my_proc_id == 0 ) then
      ...
      write(6,'(a,3x,100a  )') ' enkfvar = ',enkfvar
      write(6,'(a,3x,100a  )') ' updatevar = ',updatevar
...
subroutine wrf_var_dimension ( wrf_file, var, ix, jx, kx, ii, jj, kk )
   ...
   jj = jx
   kk = kx
   if      ( var == 'U_1       ' .or. var == 'U_2       ' ) then
      ii = ix + 1
   else if ( var == 'V_1       ' .or. var == 'V_2       ' ) then
      jj = jx + 1
   else if ( var == 'W_1       ' .or. var == 'W_2       ' .or. var == 'PHB       '  &
        .or. var == 'PH_1      ' .or. var == 'PH_2      ' ) then
      kk = kx + 1
   else if ( var == 'MU_1      ' .or. var == 'MU_2      ' .or. var == 'MUB       '  &
        .or. var == 'T2        ' .or. var == 'Q2        ' .or. var == 'TH2       '  &
   ...
   if( var == 'TSLB' .or. var == 'SMOIS' .or. var == 'SH2O' ) then
