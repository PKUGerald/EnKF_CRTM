...
!-- enkf_parameter
   ...
   character(len=10), dimension(100) :: enkfvar   ! include the variables which will be updated and be used to calculate the XB
   character(len=10), dimension(100) :: updatevar ! updated variables
   ...
   logical       :: use_sfc_theta, use_sfc_td    ! Using theta and Td instead of T and Qv for surface obs
!-- parallel
...
!-- Namelist contents :
   ...
   namelist /enkf_parameter / numbers_en, expername, enkfvar, updatevar,                          &
                                 ...
                                 inflate, mixing, random_order, print_detail, use_sfc_theta, use_sfc_td
