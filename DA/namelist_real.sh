...
end_year           = `for i in $domlist; do printf ${DATE_END:0:4}, ; done`
end_month          = `for i in $domlist; do printf ${DATE_END:4:2}, ; done`
end_day            = `for i in $domlist; do printf ${DATE_END:6:2}, ; done`
end_hour           = `for i in $domlist; do printf ${DATE_END:8:2}, ; done`
end_minute         = `for i in $domlist; do printf ${DATE_END:10:2}, ; done`
